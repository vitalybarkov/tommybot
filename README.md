...
2. next, to set up the tommybot use deploy_location/set [!WARNING] be aware, you can set up all data only once, to set up again, you'll need to redeploy the repository
